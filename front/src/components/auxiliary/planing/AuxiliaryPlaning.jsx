...
class AuxiliaryPlaning extends React.Component {
    ...
    _buildIndisponibility(indisponibility) {
        let text
        if (indisponibility.startTime && indisponibility.endTime) {
            text = `De ${MomentHelper.localTimeToHumanTime(indisponibility.startTime)} à ${MomentHelper.localTimeToHumanTime(indisponibility.endTime)}`
        } else {
