...
import AccountEditEmailDemandCodeData from './AccountEditEmailDemandCodeData'
import './AccountEditEmail.scss'

import { Button, Panel, Form, Grid } from 'ap-react-bootstrap'
 
class AccountEditEmailDemandCode extends React.Component {
	...
	componentWillMount() {
		AccountEditEmailDemandCodeData.register(this)
	}

	componentWillUnmount() {
		AccountEditEmailDemandCodeData.unregister()
	}
		...
		return (
			<div className='ap-account-edit-email'>
				...
				<Panel>
					...
					<Panel.Body>
						<p>
							Vous avez recu un code de confirmation sur votre adresse électronique actuelle.
							<br/>
							Veuillez saisir ce code ci dessous pour entamer le changement d'adresse électronique.
						</p>
						<Form horizontal>
							<Form.Group>
...
export default AccountEditEmailDemandCode