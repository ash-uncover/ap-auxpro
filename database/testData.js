...
db.auxiliary.insert({
	...
	"nationality":"BE",
	"isEntrepreneur":"Auto",
	"skillChildrenCare":NumberInt(0),
    "skillChildrenSchool":NumberInt(0),
    "skillChildrenGame":NumberInt(0),
    "skillChildrenKeep":NumberInt(0),
    "skillOldCare":NumberInt(5),
    "skillFood":NumberInt(3),
    "skillTransport":NumberInt(3),
    "skillIllness":NumberInt(1),
    "skillNursing":NumberInt(3),
    "skillClothes":NumberInt(0),
    "skillHouse":NumberInt(0),
    "skillCompany":NumberInt(0),
    "skillPet":NumberInt(0),
    "skillHandicap":NumberInt(0),
    "skillBeauty":NumberInt(4),
